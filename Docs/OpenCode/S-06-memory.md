...
| 3 | AccountsHubView | «لا توجد حركات نقدية في هذه الفترة.» | Empty-state |
| 3 | CashMovementDialogViewModel | «سيتم تسجيل {إيداع/صرف} بمبلغ {amount}. هل تريد المتابعة؟» | Confirmation |
